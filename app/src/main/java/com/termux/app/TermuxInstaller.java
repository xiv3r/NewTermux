...
public final class TermuxInstaller {
    ...
    private static void writeNewZshrc(File zshrc) {
        // Source both plugins guarded by existence checks — safe even before zsh is
        // installed; [[ -f ]] prevents errors if the plugin files are missing.
        String content =
